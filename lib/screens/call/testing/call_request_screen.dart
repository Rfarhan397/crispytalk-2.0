...
class _VideoCallScreenState extends State<CallRequestScreen> {
  ...
  void initState() {
    ...
    super.initState();
    // Access the callProvider from the context
  ...
  Widget build(BuildContext context) {
    // Provider.of<WebrtcProvider>(context,listen: false).startCall(widget.callID,audioOnly: !widget.isVideo);
    return Scaffold(
      body: SafeArea(child: Consumer<WebrtcProvider>(
            ...
            children: [
              ...
              if (provider.isUserJoined) ...[
                if (widget.isVideo)
                  Container(
                    color: Colors.black,
                    child: RTCVideoView(mirror: false, provider.remoteRenderer),
                  ),
                if (widget.isVideo)
                  Positioned(
                      top: 10.w,
                      ...
                      child: SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            color: Colors.black,
                            child: RTCVideoView(
                                mirror: true, provider.localRenderer),
                          ),
                        ),
                      ))
              ] else ...[
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                provider.endCall(widget.callID,
                                    remoteEnd: true,
